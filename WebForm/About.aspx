<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="WebForm.About" %>
                    ...
                    <div class="span12" data-motopress-wrapper-file="page-faq.php" data-motopress-wrapper-type="content">
                        ...
                        <div class="row">
                            <div class="span12" id="content" data-motopress-type="loop" data-motopress-loop-file="loop/loop-faq.php">
                                ...
                                <dl class="faq-list">
                                    <dt class="faq-list_h">
                                        <h4 class="marker">1</h4>
                                        <h4>ASP.NET</h4>
                                    </dt>
                                    <dd id="post-100" class="faq-list_body">
                                        <h4 class="marker">  </h4>
                                        <p>WebForms 4.0 提供了一些有针对性的增强，还包括一些新特性。本实验将讨论以下特性：
...
URL 路由：WebForms 4.0 引入了一个新的 PageRouteHandler 类，它将 URL 路由集成到了 Web Form Pages 中。ASP.NET 中的 URL 路由允许您在网站中使用不需要映射到具体文件的 URL。由于 URL 不需要映射到文件，因此您可以在 Web 应用中使用描述用户操作的 URL，使其能更加轻松地被用户理解。在 URL 路由中，您将定义一些包含值的占位符的 URL 模式，这些占位符将在处理 URL 请求时发挥作用。在运行时，URL 中应用程序名称后面的部分将根据您所定义的 URL 模式解析为离散的值。
   View State： WebForms 4.0 为 View State 提供了更加粒度化的控制。开发人员现在可以禁用页面上的 View State，并在特定的服务器控件上启用它，还可以在某控件上禁用它，而在其子控件上启用它。 </p>
                                    </dd>
                                ...
                                <dl class="faq-list">
                                    <dt class="faq-list_h">
                                        <h4 class="marker">2</h4>
                                        <h4>数据库</h4>
                                    </dt>
                                    <dd id="post-100" class="faq-list_body">
                                        <h4 class="marker">  </h4>
                                        <p>SQL Server是由Microsoft开发和推广的关系数据库管理系统（DBMS），它最初是由Microsoft、Sybase和Ashton-Tate三家公司共同开发的，并于1988年推出了第一个OS/2版本。Microsoft SQL Server近年来不断更新版本，1996年，Microsoft 推出了SQL Server 6.5版本；1998年，SQL Server 7.0版本和用户见面；SQL Server 2000是Microsoft公司于2000年推出，目前最新版本是2017年份推出的SQL SERVER 2017</p>
                                    </dd>
