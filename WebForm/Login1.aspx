...
<body>
    ...
    <table cellpadding="0" cellspacing="1" border="0" style="width:95%; margin:0 auto;">
        <tr>
            ...
            <td><input type="text" class="mytext" id="Account" name="Account" value="xh" maxlength="50" style="width:170px;" /></td>
        </tr>
        <tr>
...
<%--                <button id="btn1" onclick="toindex()" class="mybutton" style="height:25px; text-align:right;float:right;">学员浏览</button>--%>
            </td>
        </tr>            
    </table>
    </form>
