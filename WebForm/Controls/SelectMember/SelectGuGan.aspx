<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectGuGan.aspx.cs" Inherits="WebForm.Controls.SelectMember.SelectGuGan" %>
...
<body onload="opener.location.reload()">
    ...
    <script type="text/javascript">
        ...
        var myQb = '<%=Request.QueryString["roleid"]%>';
        ...
        function confirm1()
        {
            ...
            //win.close();value
            window.location.href = "/PlatForm/Members/Body.aspx?Leader=" + value + '&id=' + myQb + '&appid=' + appid;
            //history.go(-1);
        }
