<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectJiaoYuan.aspx.cs" Inherits="WebForm.Controls.SelectJiaoYuan" %>
...
<body onload="opener.location.reload()">
    ...
    <script type="text/javascript">
        ...
        function confirm1()
        {
            ...
            //win.close();value
            window.location.href = "/PlatForm/Members/Body.aspx?ChargeLeader=" + value + '&id=' + myQb + '&appid=' + appid;
            //history.go(-1);
        }
