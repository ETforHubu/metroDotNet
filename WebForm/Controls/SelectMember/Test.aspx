<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="WebForm.Controls.SelectMember.Test" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style type="text/css">
     ...
     <script type='text/javascript' src='../../Scripts/historyUtils.js'></script>
...
<body onload="opener.location.reload()">
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:4px;">
        <tr>
            ...
            <td align="center" style="padding:0px 6px;" valign="middle">
                ...
                <div><button class="mybutton" onclick="history.go(-1);">取消</button></div>
            </td>
            <td valign="top">
    ...
    <script type="text/javascript">
        ...
        var myRole = '<%=Request.QueryString["roleid"]%>';
        ...
        function confirm1()
        {
            ...
            var ele = getOpenerElement(eid);
            var ele1 = getOpenerElement(eid + "_text");
            ...
            //win.close();value
            window.location.href = "/PlatForm/RoleApp/EditRole.aspx?UseMember=" + value + '&roleid=' + myRole + '&appid=' + appid;
            //history.go(-1);
        }
