    ...
    public partial class Login1 : WebForm.Common.BasePage
    {
        ...
        private void check()
        {
            ...
            else
            {
                ...
                //RoadFlow.Platform.Students bstudents = new RoadFlow.Platform.Students();

                var user = busers.GetByAccount(account.Trim());

                //var student = bstudents.GetByAccount(account.Trim());
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            //Script = "top.location='" + Common.Tools.BaseUrl + "Index.aspx';";
                        }
                    }
                }
            }
