<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultForStudent.aspx.cs" Inherits="WebForm.Platform.Members.DefaultForStudent" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="span12" data-motopress-wrapper-file="page-faq.php" data-motopress-wrapper-type="content">
                        ...
                        <div class="row">
                            <div class="span3">
                                <iframe id="Iframe1" frameborder="0" scrolling="auto" src="TreeForJiaoYuan.aspx?appid=<%=Request.QueryString["appid"] %>" style="width: 100%; margin: 0; padding: 0;"></iframe>
                            </div>
                            <div class="span9">
                                <iframe id="Iframe2" frameborder="0" scrolling="auto" src="Body.aspx?appid=<%=Request.QueryString["appid"] %>" style="width: 100%; height: 600px; margin: 0; padding: 0;"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
