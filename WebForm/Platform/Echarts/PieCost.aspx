<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PieCost.aspx.cs" Inherits="WebForm.Platform.Echarts.PieCost" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="span12" data-motopress-wrapper-file="page-faq.php" data-motopress-wrapper-type="content">
                        <div class="row">
                            <div class="span12" data-motopress-type="static" data-motopress-static-file="static/static-title.php">
                                <section class="title-section">
                                    <h1 class="title-header">学员管理				
                                    </h1>
                                    <!-- BEGIN BREADCRUMBS-->
                                    <ul class="breadcrumb breadcrumb__t">
                                        <li><a href="/Index.aspx">网站首页</a></li>
                                        <li class="divider"></li>
                                        <li class="active">费用饼状图</li>
                                    </ul>
                                    <!-- END BREADCRUMBS -->
                                </section>
                                <!-- .title-section -->
                        ...
                        <div class="row" style="min-width:300px <div class="row">
                            <div class="span6">
                                <iframe id="Iframe1" frameborder="0" scrolling="auto" src="piecost.htm" style="width: 100%; margin: 0; padding: 0;"></iframe>
                            </div>
                            <div class="span6">
                                <iframe id="Iframe2" frameborder="0" scrolling="auto" src="bar.htm" style="width: 100%; height: 600px; margin: 0; padding: 0;"></iframe>
                            </div>
                        </div>                
