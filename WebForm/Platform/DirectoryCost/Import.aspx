<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import.aspx.cs" Inherits="WebForm.Platform.DirectoryCost.Import" %>
                        ...
                        <div class="row" style="min-width:300px">
                            <div class="span12">
                                ...
                                <form runat="server"  method="post" enctype="multipart/form-data">
                                    ...
                                    <asp:FileUpload ID="FileUpload1" runat="server" Width="618px" />

                                    <asp:Button ID="btnAdd" runat="server" Text="导入" OnClick="btnAdd_Click" />
                                    </div>
                                </form>
                            </div>
