<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Directories.aspx.cs" Inherits="WebForm.Platform.DirectoryCost.Directories" %>
<!DOCTYPE html>
        ...
        <div class=" motopress-wrapper  content-holder clearfix">
            <div class="container">
                <div class="row" style="padding-left:20px;">
                    ...
                    <div class="row" style="padding-left:20px;box-sizing:border-box;">
                       <div class="span3" >
                          <iframe id="Iframe1" frameborder="0" scrolling="auto" src="TreeForDirectory.aspx?appid=<%=Request.QueryString["appid"] %>" style="width: 100%; margin: 0; padding: 0;"></iframe>
                       </div>
                       <div class="span9">
                          <iframe id="Iframe2" frameborder="0" scrolling="auto" src="DirectoriesBody.aspx?appid=<%=Request.QueryString["appid"] %>" style="width: 100%; height: 600px; margin: 0; padding: 0;"></iframe>
                       </div>
                     </div>
                </div>
            </div>
