<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultIndex.aspx.cs" Inherits="WebForm.Platform.Log.DefaultIndex" %>
...
<div  >
     ...
     <iframe id="<%=Iframeid %>" frameborder="0" scrolling="auto" src="List.aspx?<%=Query %>" style="width:95%; margin:0;padding:0;"></iframe>  
</div>
                        <%--<div class="span1">
