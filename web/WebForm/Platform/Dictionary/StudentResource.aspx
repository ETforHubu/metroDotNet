<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentResource.aspx.cs" Inherits="WebForm.Platform.Dictionary.StudentResource" %>
                            ...
                            <div class="span8" data-motopress-type="static" data-motopress-static-file="static/static-nav.php">
                               <nav class="nav nav__primary clearfix">
                                    <ul id="topnav" class="sf-menu">
                                        ...
                                        <li id="menu-item-2024" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="/Platform/Dictionary/StudentResource.aspx?appid=a314bdce-1124-4e05-9151-cc186ab82a77">资源下载</a></li>                         
                                    </ul>
                                </nav>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="span12" data-motopress-wrapper-file="page-faq.php" data-motopress-wrapper-type="content">
                        ...
                        <div class="row">
                            <div class="span3">
                                <iframe id="Iframe1" frameborder="0" scrolling="auto" src="TreeForStudent.aspx?appid=<%=Request.QueryString["appid"] %>" style="width: 100%; margin: 0; padding: 0;"></iframe>
                            </div>
                            <div class="span9">
                                <iframe id="Iframe2" frameborder="0" scrolling="auto" src="files.aspx?appid=<%=Request.QueryString["appid"] %>" style="width:100%; height: 600px; margin: 0; padding: 0;"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
