<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewDefault.aspx.cs" Inherits="WebForm.Platform.OnlineUsers.NewDefault" %>
...
<div  >
     ...
     <iframe id="<%=Iframeid %>" frameborder="0" scrolling="auto" src="Default.aspx?<%=Query %>" style="width:95%; margin:0;padding:0;"></iframe>  
</div>
                        <%--<div class="span1">
