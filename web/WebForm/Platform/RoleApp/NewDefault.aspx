<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewDefault.aspx.cs" Inherits="WebForm.Platform.RoleApp.NewDefault" %>
<!DOCTYPE html>
                            ...
                            <div class="card-content">
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <iframe id="Iframe1" frameborder="0" scrolling="auto" style="width:10px;margin:0;padding:0"class="height-650">></iframe> 
                                        <iframe id="<%=Iframeid %>" frameborder="0" scrolling="auto" src="List.aspx?<%=Query %>" style="width:90%; margin:0;padding:0;" class="height-650">></iframe>  
