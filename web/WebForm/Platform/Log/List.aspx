<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebForm.Platform.Log.List" %>
...
<%--    <div class="buttondiv"><asp:Literal ID="Pager" runat="server" EnableViewState="true"></asp:Literal></div> --%>
    </form>
    ...
    <script type="text/javascript">
        ...
        function detail(id)
        {
            window.location.href = "Detail.aspx?id=" + id + '<%=Query%>';
