...
<body>
    ...
    <script type="text/javascript">
        ...
        function setUserApp()
        {
            window.location = '/Platform/UserApp/Default.aspx' + '<%=Request.Url.Query%>';
            <%--var mainDialog = new RoadUI.Window();
            mainDialog.open({url:  "/Platform/UserApp/Default.aspx"+"<%=Request.Url.Query%>",width:760,height:530,title:"设置人员应用"});
            return false;--%>
        }
    </script>
</body>
