<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TreeForJiaoYuan.aspx.cs" Inherits="WebForm.Platform.Members.TreeForStudent" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        {
            //alert("treeZou!");
            roadTree = new RoadUI.Tree({ id: "tree", path: "Tree2.ashx?ischild=1", refreshpath: "TreeRefresh.ashx", onclick: openUrl });
        });
