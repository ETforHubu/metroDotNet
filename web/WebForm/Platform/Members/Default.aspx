                            ...
                            <div class="card-content">
                                <div class="row">
                                    <div class="col-md-3 col-12">
                                         <iframe id="Iframe1" frameborder="0" scrolling="auto" src="TreeIndex.aspx??appid=<%=Request.QueryString["appid"] %>" style="width:100%;margin:0;padding:0;" class="height-650"></iframe> 
                                    </div>
                                    <div class="col-md-9 col-12" >
                                        <iframe id="Iframe2" frameborder="0" scrolling="auto" src="Body.aspx?appid=<%=Request.QueryString["appid"] %>" style="width:100%;margin:0;padding:0;" class="height-650"></iframe> 
                                    </div>
                                </div>
                            </div>
                        </div>
